...
namespace ClangPowerTools
{
  public class ScriptConstants
  {
    ...
    public const string kScriptBeginning = @"Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass; PowerShell.exe -ExecutionPolicy Bypass -NoProfile -Noninteractive -command '&";
