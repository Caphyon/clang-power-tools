...
{
  public class ClangTidyChecksOptionsView : ConfigurationPage<ClangTidyChecksOptions>
  {
    #region Members
    ...
    public override void SaveSettingsToStorage()
    {
      var updatedConfig = new ClangTidyChecksOptions
      {
        ...
        AndroidCloexecSocket = this.AndroidCloexecSocket,
        BoostUseToString = this.BoostUseToString,
        BugproneSuspiciousMemsetUsage = this.BugproneSuspiciousMemsetUsage,
        BugproneUndefinedMemoryManipulation = this.BugproneUndefinedMemoryManipulation,
        CertDcl03C = this.CertDcl03C,
        CertDcl21Cpp = this.CertDcl21Cpp,
        CertDcl50Cpp = this.CertDcl50Cpp,
        CertDcl54Cpp = this.CertDcl54Cpp,
        CertDcl58Cpp = this.CertDcl58Cpp,
        CertDcl59Cpp = this.CertDcl59Cpp,
        CertEnv33C = this.CertEnv33C,
        CertErr09Cpp = this.CertErr09Cpp,
        CertErr34C = this.CertErr34C,
        CertErr52Cpp = this.CertErr52Cpp,
        CertErr58Cpp = this.CertErr58Cpp,
        CertErr60Cpp = this.CertErr60Cpp,
        CertErr61Cpp = this.CertErr61Cpp,
        CertFio38C = this.CertFio38C,
        CertFlp30C = this.CertFlp30C,
        ...
        CppcoreguidelinesProBoundsArrayToPointerDecay = this.CppcoreguidelinesProBoundsArrayToPointerDecay,
        CppcoreguidelinesProBoundsConstantArrayIndex = this.CppcoreguidelinesProBoundsConstantArrayIndex,
        CppcoreguidelinesProBoundsPointerArithmetic = this.CppcoreguidelinesProBoundsPointerArithmetic,
        CppcoreguidelinesProTypeConstCast = this.CppcoreguidelinesProTypeConstCast,
        CppcoreguidelinesProTypeCstyleCast = this.CppcoreguidelinesProTypeCstyleCast,
        CppcoreguidelinesProTypeMemberInit = this.CppcoreguidelinesProTypeMemberInit,
        CppcoreguidelinesProTypeReinterpretCast = this.CppcoreguidelinesProTypeReinterpretCast,
        CppcoreguidelinesProTypeStaticCastDowncast = this.CppcoreguidelinesProTypeStaticCastDowncast,
        CppcoreguidelinesProTypeUnionAccess = this.CppcoreguidelinesProTypeUnionAccess,
        CppcoreguidelinesProTypeVararg = this.CppcoreguidelinesProTypeVararg,
        CppcoreguidelinesSlicing = this.CppcoreguidelinesSlicing,
        CppcoreguidelinesSpecialMemberFunctions = this.CppcoreguidelinesSpecialMemberFunctions,
        GoogleBuildExplicitMakePair = this.GoogleBuildExplicitMakePair,
        GoogleBuildNamespaces = this.GoogleBuildNamespaces,
        GoogleBuildUsingNamespace = this.GoogleBuildUsingNamespace,
        GoogleDefaultArguments = this.GoogleDefaultArguments,
        GoogleExplicitConstructor = this.GoogleExplicitConstructor,
        GoogleGlobalNamesInHeaders = this.GoogleGlobalNamesInHeaders,
        GoogleReadabilityBracesAroundStatements = this.GoogleReadabilityBracesAroundStatements,
        GoogleReadabilityCasting = this.GoogleReadabilityCasting,
        GoogleReadabilityFunctionSize = this.GoogleReadabilityFunctionSize,
        GoogleReadabilityNamespaceComments = this.GoogleReadabilityNamespaceComments,
        GoogleReadabilityRedundantSmartptrGet = this.GoogleReadabilityRedundantSmartptrGet,
        GoogleReadabilityTodo = this.GoogleReadabilityTodo,
        GoogleRuntimeInt = this.GoogleRuntimeInt,
        GoogleRuntimeMemberStringReferences = this.GoogleRuntimeMemberStringReferences,
        GoogleRuntimeOperator = this.GoogleRuntimeOperator,
        GoogleRuntimeReferences = this.GoogleRuntimeReferences,
        HicppExplicitConversions = this.HicppExplicitConversions,
        HicppFunctionSize = this.HicppFunctionSize,
        HicppInvalidAccessMoved = this.HicppInvalidAccessMoved,
        HicppMemberInit = this.HicppMemberInit,
        HicppNamedParameter = this.HicppNamedParameter,
        HicppNewDeleteOperators = this.HicppNewDeleteOperators,
        HicppNoAssembler = this.HicppNoAssembler,
        HicppNoexceptMove = this.HicppNoexceptMove,
        HicppSpecialMemberFunctions = this.HicppSpecialMemberFunctions,
        HicppUndelegatedConstructor = this.HicppUndelegatedConstructor,
        HicppUseEqualsDefault = this.HicppUseEqualsDefault,
        HicppUseEqualsDelete = this.HicppUseEqualsDelete,
        HicppUseOverride = this.HicppUseOverride,
        LlvmHeaderGuard = this.LlvmHeaderGuard,
        LlvmIncludeOrder = this.LlvmIncludeOrder,
        LlvmNamespaceComment = this.LlvmNamespaceComment,
        LlvmTwineLocal = this.LlvmTwineLocal,
        MiscArgumentComment = this.MiscArgumentComment,
        MiscAssertSideEffect = this.MiscAssertSideEffect,
        MiscBoolPointerImplicitConversion = this.MiscBoolPointerImplicitConversion,
        MiscDanglingHandle = this.MiscDanglingHandle,
        MiscDefinitionsInHeaders = this.MiscDefinitionsInHeaders,
        MiscFoldInitType = this.MiscFoldInitType,
        MiscForwardDeclarationNamespace = this.MiscForwardDeclarationNamespace,
        MiscForwardingReferenceOverload = this.MiscForwardingReferenceOverload,
        MiscInaccurateErase = this.MiscInaccurateErase,
        MiscIncorrectRoundings = this.MiscIncorrectRoundings,
        MiscInefficientAlgorithm = this.MiscInefficientAlgorithm,
        MiscLambdaFunctionName = this.MiscLambdaFunctionName,
        MiscMacroParentheses = this.MiscMacroParentheses,
        MiscMacroRepeatedSideEffects = this.MiscMacroRepeatedSideEffects,
        MiscMisplacedConst = this.MiscMisplacedConst,
        MiscMisplacedWideningCast = this.MiscMisplacedWideningCast,
        MiscMoveConstArg = this.MiscMoveConstArg,
        MiscMoveConstructorInit = this.MiscMoveConstructorInit,
        MiscMoveForwardingReference = this.MiscMoveForwardingReference,
        MiscMultipleStatementMacro = this.MiscMultipleStatementMacro,
        MiscNewDeleteOverloads = this.MiscNewDeleteOverloads,
        MiscNoexceptMoveConstructor = this.MiscNoexceptMoveConstructor,
        MiscNonCopyableObjects = this.MiscNonCopyableObjects,
        MiscRedundantExpression = this.MiscRedundantExpression,
        MiscSizeofContainer = this.MiscSizeofContainer,
        MiscSizeofExpression = this.MiscSizeofExpression,
        MiscStaticAssert = this.MiscStaticAssert,
        MiscStringCompare = this.MiscStringCompare,
        MiscStringConstructor = this.MiscStringConstructor,
        MiscStringIntegerAssignment = this.MiscStringIntegerAssignment,
        MiscStringLiteralWithEmbeddedNul = this.MiscStringLiteralWithEmbeddedNul,
        MiscSuspiciousEnumUsage = this.MiscSuspiciousEnumUsage,
        MiscSuspiciousMissingComma = this.MiscSuspiciousMissingComma,
        MiscSuspiciousSemicolon = this.MiscSuspiciousSemicolon,
        MiscSuspiciousStringCompare = this.MiscSuspiciousStringCompare,
        MiscSwappedArguments = this.MiscSwappedArguments,
        MiscThrowByValueCatchByReference = this.MiscThrowByValueCatchByReference,
        MiscUnconventionalAssignOperator = this.MiscUnconventionalAssignOperator,
        MiscUndelegatedConstructor = this.MiscUndelegatedConstructor,
        MiscUniqueptrResetRelease = this.MiscUniqueptrResetRelease,
        MiscUnusedAliasDecls = this.MiscUnusedAliasDecls,
        MiscUnusedParameters = this.MiscUnusedParameters,
        MiscUnusedRaii = this.MiscUnusedRaii,
        MiscUnusedUsingDecls = this.MiscUnusedUsingDecls,
        MiscUseAfterMove = this.MiscUseAfterMove,
        MiscVirtualNearMiss = this.MiscVirtualNearMiss,
        ModernizeAvoidBind = this.ModernizeAvoidBind,
        ModernizeDeprecatedHeaders = this.ModernizeDeprecatedHeaders,
        ModernizeLoopConvert = this.ModernizeLoopConvert,
        ModernizeMakeShared = this.ModernizeMakeShared,
        ModernizeMakeUnique = this.ModernizeMakeUnique,
        ModernizePassByValue = this.ModernizePassByValue,
        ModernizeRawStringLiteral = this.ModernizeRawStringLiteral,
        ModernizeRedundantVoidArg = this.ModernizeRedundantVoidArg,
        ModernizeReplaceAutoPtr = this.ModernizeReplaceAutoPtr,
        ModernizeReplaceRandomShuffle = this.ModernizeReplaceRandomShuffle,
        ModernizeReturnBracedInitList = this.ModernizeReturnBracedInitList,
        ModernizeShrinkToFit = this.ModernizeShrinkToFit,
        ModernizeUnaryStaticAssert = this.ModernizeUnaryStaticAssert,
        ModernizeUseAuto = this.ModernizeUseAuto,
        ModernizeUseBoolLiterals = this.ModernizeUseBoolLiterals,
        ModernizeUseDefaultMemberInit = this.ModernizeUseDefaultMemberInit,
        ModernizeUseEmplace = this.ModernizeUseEmplace,
        ModernizeUseEqualsDefault = this.ModernizeUseEqualsDefault,
        ModernizeUseEqualsDelete = this.ModernizeUseEqualsDelete,
        ModernizeUseNoexcept = this.ModernizeUseNoexcept,
        ModernizeUseNullptr = this.ModernizeUseNullptr,
        ModernizeUseOverride = this.ModernizeUseOverride,
        ModernizeUseTransparentFunctors = this.ModernizeUseTransparentFunctors,
        ModernizeUseUsing = this.ModernizeUseUsing,
        MpiBufferDeref = this.MpiBufferDeref,
        ...
        PerformanceUnnecessaryCopyInitialization = this.PerformanceUnnecessaryCopyInitialization,
        PerformanceUnnecessaryValueParam = this.PerformanceUnnecessaryValueParam,
        ...
        ReadabilityNamedParameter = this.ReadabilityNamedParameter,
        ReadabilityNonConstParameter = this.ReadabilityNonConstParameter,
        ReadabilityRedundantControlFlow = this.ReadabilityRedundantControlFlow,
        ReadabilityRedundantDeclaration = this.ReadabilityRedundantDeclaration,
        ReadabilityRedundantFunctionPtrDereference = this.ReadabilityRedundantFunctionPtrDereference,
        ReadabilityRedundantMemberInit = this.ReadabilityRedundantMemberInit,
        ReadabilityRedundantSmartptrGet = this.ReadabilityRedundantSmartptrGet,
        ReadabilityRedundantStringCstr = this.ReadabilityRedundantStringCstr,
        ReadabilityRedundantStringInit = this.ReadabilityRedundantStringInit,
    ...
    public override void LoadSettingsFromStorage()
    {
      ...
      this.AndroidCloexecSocket = loadedConfig.AndroidCloexecSocket;
      this.BoostUseToString = loadedConfig.BoostUseToString;
      this.BugproneSuspiciousMemsetUsage = loadedConfig.BugproneSuspiciousMemsetUsage;
      this.BugproneUndefinedMemoryManipulation = loadedConfig.BugproneUndefinedMemoryManipulation;
      this.CertDcl03C = loadedConfig.CertDcl03C;
      this.CertDcl21Cpp = loadedConfig.CertDcl21Cpp;
      this.CertDcl50Cpp = loadedConfig.CertDcl50Cpp;
      this.CertDcl54Cpp = loadedConfig.CertDcl54Cpp;
      this.CertDcl58Cpp = loadedConfig.CertDcl58Cpp;
      this.CertDcl59Cpp = loadedConfig.CertDcl59Cpp;
      this.CertEnv33C = loadedConfig.CertEnv33C;
      this.CertErr09Cpp = loadedConfig.CertErr09Cpp;
      this.CertErr34C = loadedConfig.CertErr34C;
      this.CertErr52Cpp = loadedConfig.CertErr52Cpp;
      this.CertErr58Cpp = loadedConfig.CertErr58Cpp;
      this.CertErr60Cpp = loadedConfig.CertErr60Cpp;
      this.CertErr61Cpp = loadedConfig.CertErr61Cpp;
      this.CertFio38C = loadedConfig.CertFio38C;
      this.CertFlp30C = loadedConfig.CertFlp30C;
      ...
      this.CppcoreguidelinesProBoundsArrayToPointerDecay = loadedConfig.CppcoreguidelinesProBoundsArrayToPointerDecay;
      this.CppcoreguidelinesProBoundsConstantArrayIndex = loadedConfig.CppcoreguidelinesProBoundsConstantArrayIndex;
      this.CppcoreguidelinesProBoundsPointerArithmetic = loadedConfig.CppcoreguidelinesProBoundsPointerArithmetic;
      this.CppcoreguidelinesProTypeConstCast = loadedConfig.CppcoreguidelinesProTypeConstCast;
      this.CppcoreguidelinesProTypeCstyleCast = loadedConfig.CppcoreguidelinesProTypeCstyleCast;
      this.CppcoreguidelinesProTypeMemberInit = loadedConfig.CppcoreguidelinesProTypeMemberInit;
      this.CppcoreguidelinesProTypeReinterpretCast = loadedConfig.CppcoreguidelinesProTypeReinterpretCast;
      this.CppcoreguidelinesProTypeStaticCastDowncast = loadedConfig.CppcoreguidelinesProTypeStaticCastDowncast;
      this.CppcoreguidelinesProTypeUnionAccess = loadedConfig.CppcoreguidelinesProTypeUnionAccess;
      this.CppcoreguidelinesProTypeVararg = loadedConfig.CppcoreguidelinesProTypeVararg;
      this.CppcoreguidelinesSlicing = loadedConfig.CppcoreguidelinesSlicing;
      this.CppcoreguidelinesSpecialMemberFunctions = loadedConfig.CppcoreguidelinesSpecialMemberFunctions;
      this.GoogleBuildExplicitMakePair = loadedConfig.GoogleBuildExplicitMakePair;
      this.GoogleBuildNamespaces = loadedConfig.GoogleBuildNamespaces;
      this.GoogleBuildUsingNamespace = loadedConfig.GoogleBuildUsingNamespace;
      this.GoogleDefaultArguments = loadedConfig.GoogleDefaultArguments;
      this.GoogleExplicitConstructor = loadedConfig.GoogleExplicitConstructor;
      this.GoogleGlobalNamesInHeaders = loadedConfig.GoogleGlobalNamesInHeaders;
      this.GoogleReadabilityBracesAroundStatements = loadedConfig.GoogleReadabilityBracesAroundStatements;
      this.GoogleReadabilityCasting = loadedConfig.GoogleReadabilityCasting;
      this.GoogleReadabilityFunctionSize = loadedConfig.GoogleReadabilityFunctionSize;
      this.GoogleReadabilityNamespaceComments = loadedConfig.GoogleReadabilityNamespaceComments;
      this.GoogleReadabilityRedundantSmartptrGet = loadedConfig.GoogleReadabilityRedundantSmartptrGet;
      this.GoogleReadabilityTodo = loadedConfig.GoogleReadabilityTodo;
      this.GoogleRuntimeInt = loadedConfig.GoogleRuntimeInt;
      this.GoogleRuntimeMemberStringReferences = loadedConfig.GoogleRuntimeMemberStringReferences;
      this.GoogleRuntimeOperator = loadedConfig.GoogleRuntimeOperator;
      this.GoogleRuntimeReferences = loadedConfig.GoogleRuntimeReferences;
      this.HicppExplicitConversions = loadedConfig.HicppExplicitConversions;
      this.HicppFunctionSize = loadedConfig.HicppFunctionSize;
      this.HicppInvalidAccessMoved = loadedConfig.HicppInvalidAccessMoved;
      this.HicppMemberInit = loadedConfig.HicppMemberInit;
      this.HicppNamedParameter = loadedConfig.HicppNamedParameter;
      this.HicppNewDeleteOperators = loadedConfig.HicppNewDeleteOperators;
      this.HicppNoAssembler = loadedConfig.HicppNoAssembler;
      this.HicppNoexceptMove = loadedConfig.HicppNoexceptMove;
      this.HicppSpecialMemberFunctions = loadedConfig.HicppSpecialMemberFunctions;
      this.HicppUndelegatedConstructor = loadedConfig.HicppUndelegatedConstructor;
      this.HicppUseEqualsDefault = loadedConfig.HicppUseEqualsDefault;
      this.HicppUseEqualsDelete = loadedConfig.HicppUseEqualsDelete;
      this.HicppUseOverride = loadedConfig.HicppUseOverride;
      this.LlvmHeaderGuard = loadedConfig.LlvmHeaderGuard;
      this.LlvmIncludeOrder = loadedConfig.LlvmIncludeOrder;
      this.LlvmNamespaceComment = loadedConfig.LlvmNamespaceComment;
      this.LlvmTwineLocal = loadedConfig.LlvmTwineLocal;
      this.MiscArgumentComment = loadedConfig.MiscArgumentComment;
      this.MiscAssertSideEffect = loadedConfig.MiscAssertSideEffect;
      this.MiscBoolPointerImplicitConversion = loadedConfig.MiscBoolPointerImplicitConversion;
      this.MiscDanglingHandle = loadedConfig.MiscDanglingHandle;
      this.MiscDefinitionsInHeaders = loadedConfig.MiscDefinitionsInHeaders;
      this.MiscFoldInitType = loadedConfig.MiscFoldInitType;
      this.MiscForwardDeclarationNamespace = loadedConfig.MiscForwardDeclarationNamespace;
      this.MiscForwardingReferenceOverload = loadedConfig.MiscForwardingReferenceOverload;
      this.MiscInaccurateErase = loadedConfig.MiscInaccurateErase;
      this.MiscIncorrectRoundings = loadedConfig.MiscIncorrectRoundings;
      this.MiscInefficientAlgorithm = loadedConfig.MiscInefficientAlgorithm;
      this.MiscLambdaFunctionName = loadedConfig.MiscLambdaFunctionName;
      this.MiscMacroParentheses = loadedConfig.MiscMacroParentheses;
      this.MiscMacroRepeatedSideEffects = loadedConfig.MiscMacroRepeatedSideEffects;
      this.MiscMisplacedConst = loadedConfig.MiscMisplacedConst;
      this.MiscMisplacedWideningCast = loadedConfig.MiscMisplacedWideningCast;
      this.MiscMoveConstArg = loadedConfig.MiscMoveConstArg;
      this.MiscMoveConstructorInit = loadedConfig.MiscMoveConstructorInit;
      this.MiscMoveForwardingReference = loadedConfig.MiscMoveForwardingReference;
      this.MiscMultipleStatementMacro = loadedConfig.MiscMultipleStatementMacro;
      this.MiscNewDeleteOverloads = loadedConfig.MiscNewDeleteOverloads;
      this.MiscNoexceptMoveConstructor = loadedConfig.MiscNoexceptMoveConstructor;
      this.MiscNonCopyableObjects = loadedConfig.MiscNonCopyableObjects;
      this.MiscRedundantExpression = loadedConfig.MiscRedundantExpression;
      this.MiscSizeofContainer = loadedConfig.MiscSizeofContainer;
      this.MiscSizeofExpression = loadedConfig.MiscSizeofExpression;
      this.MiscStaticAssert = loadedConfig.MiscStaticAssert;
      this.MiscStringCompare = loadedConfig.MiscStringCompare;
      this.MiscStringConstructor = loadedConfig.MiscStringConstructor;
      this.MiscStringIntegerAssignment = loadedConfig.MiscStringIntegerAssignment;
      this.MiscStringLiteralWithEmbeddedNul = loadedConfig.MiscStringLiteralWithEmbeddedNul;
      this.MiscSuspiciousEnumUsage = loadedConfig.MiscSuspiciousEnumUsage;
      this.MiscSuspiciousMissingComma = loadedConfig.MiscSuspiciousMissingComma;
      this.MiscSuspiciousSemicolon = loadedConfig.MiscSuspiciousSemicolon;
      this.MiscSuspiciousStringCompare = loadedConfig.MiscSuspiciousStringCompare;
      this.MiscSwappedArguments = loadedConfig.MiscSwappedArguments;
      this.MiscThrowByValueCatchByReference = loadedConfig.MiscThrowByValueCatchByReference;
      this.MiscUnconventionalAssignOperator = loadedConfig.MiscUnconventionalAssignOperator;
      this.MiscUndelegatedConstructor = loadedConfig.MiscUndelegatedConstructor;
      this.MiscUniqueptrResetRelease = loadedConfig.MiscUniqueptrResetRelease;
      this.MiscUnusedAliasDecls = loadedConfig.MiscUnusedAliasDecls;
      this.MiscUnusedParameters = loadedConfig.MiscUnusedParameters;
      this.MiscUnusedRaii = loadedConfig.MiscUnusedRaii;
      this.MiscUnusedUsingDecls = loadedConfig.MiscUnusedUsingDecls;
      this.MiscUseAfterMove = loadedConfig.MiscUseAfterMove;
      this.MiscVirtualNearMiss = loadedConfig.MiscVirtualNearMiss;
      this.ModernizeAvoidBind = loadedConfig.ModernizeAvoidBind;
      this.ModernizeDeprecatedHeaders = loadedConfig.ModernizeDeprecatedHeaders;
      this.ModernizeLoopConvert = loadedConfig.ModernizeLoopConvert;
      this.ModernizeMakeShared = loadedConfig.ModernizeMakeShared;
      this.ModernizeMakeUnique = loadedConfig.ModernizeMakeUnique;
      this.ModernizePassByValue = loadedConfig.ModernizePassByValue;
      this.ModernizeRawStringLiteral = loadedConfig.ModernizeRawStringLiteral;
      this.ModernizeRedundantVoidArg = loadedConfig.ModernizeRedundantVoidArg;
      this.ModernizeReplaceAutoPtr = loadedConfig.ModernizeReplaceAutoPtr;
      this.ModernizeReplaceRandomShuffle = loadedConfig.ModernizeReplaceRandomShuffle;
      this.ModernizeReturnBracedInitList = loadedConfig.ModernizeReturnBracedInitList;
      this.ModernizeShrinkToFit = loadedConfig.ModernizeShrinkToFit;
      this.ModernizeUnaryStaticAssert = loadedConfig.ModernizeUnaryStaticAssert;
      this.ModernizeUseAuto = loadedConfig.ModernizeUseAuto;
      this.ModernizeUseBoolLiterals = loadedConfig.ModernizeUseBoolLiterals;
      this.ModernizeUseDefaultMemberInit = loadedConfig.ModernizeUseDefaultMemberInit;
      this.ModernizeUseEmplace = loadedConfig.ModernizeUseEmplace;
      this.ModernizeUseEqualsDefault = loadedConfig.ModernizeUseEqualsDefault;
      this.ModernizeUseEqualsDelete = loadedConfig.ModernizeUseEqualsDelete;
      this.ModernizeUseNoexcept = loadedConfig.ModernizeUseNoexcept;
      this.ModernizeUseNullptr = loadedConfig.ModernizeUseNullptr;
      this.ModernizeUseOverride = loadedConfig.ModernizeUseOverride;
      this.ModernizeUseTransparentFunctors = loadedConfig.ModernizeUseTransparentFunctors;
      this.ModernizeUseUsing = loadedConfig.ModernizeUseUsing;
      this.MpiBufferDeref = loadedConfig.MpiBufferDeref;
      ...
      this.PerformanceUnnecessaryCopyInitialization = loadedConfig.PerformanceUnnecessaryCopyInitialization;
      this.PerformanceUnnecessaryValueParam = loadedConfig.PerformanceUnnecessaryValueParam;
      ...
      this.ReadabilityNamedParameter = loadedConfig.ReadabilityNamedParameter;
      this.ReadabilityNonConstParameter = loadedConfig.ReadabilityNonConstParameter;
      this.ReadabilityRedundantControlFlow = loadedConfig.ReadabilityRedundantControlFlow;
      this.ReadabilityRedundantDeclaration = loadedConfig.ReadabilityRedundantDeclaration;
      this.ReadabilityRedundantFunctionPtrDereference = loadedConfig.ReadabilityRedundantFunctionPtrDereference;
      this.ReadabilityRedundantMemberInit = loadedConfig.ReadabilityRedundantMemberInit;
      this.ReadabilityRedundantSmartptrGet = loadedConfig.ReadabilityRedundantSmartptrGet;
      this.ReadabilityRedundantStringCstr = loadedConfig.ReadabilityRedundantStringCstr;
      this.ReadabilityRedundantStringInit = loadedConfig.ReadabilityRedundantStringInit;
