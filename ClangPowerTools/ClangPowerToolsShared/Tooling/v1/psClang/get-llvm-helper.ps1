...
Set-Variable -name kCptGithubLlvm -value "https://github.com/Caphyon/clang-power-tools/releases/download/v9.2" `
                                  -option Constant
Set-Variable -name kCptGithubLlvmVersion -value "15.0.4 (LLVM 15.0.4)" -Option Constant
