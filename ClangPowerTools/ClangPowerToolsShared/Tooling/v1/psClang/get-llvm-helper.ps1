...
Set-Variable -name kCptGithubLlvm -value "https://github.com/Caphyon/clang-power-tools/releases/download/v9.3" `
                                  -option Constant
Set-Variable -name kCptGithubLlvmVersion -value "15.0.3 (LLVM 15.0.3)" -Option Constant
