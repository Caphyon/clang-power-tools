...
Set-Variable -name kCptGithubLlvm -value "https://github.com/Caphyon/clang-power-tools/releases/download/v2025.1.0" `
                                  -option Constant
Set-Variable -name kCptGithubLlvmVersion -value "20.1.0 (LLVM 20.1.0)" -Option Constant
