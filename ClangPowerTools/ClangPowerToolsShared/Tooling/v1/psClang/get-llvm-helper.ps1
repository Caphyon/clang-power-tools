...
Set-Variable -name kCptGithubLlvm -value "https://github.com/Caphyon/clang-power-tools/releases/download/v9.1" `
                                  -option Constant
Set-Variable -name kCptGithubLlvmVersion -value "15.0.0 (LLVM 15.0.0)" -Option Constant
