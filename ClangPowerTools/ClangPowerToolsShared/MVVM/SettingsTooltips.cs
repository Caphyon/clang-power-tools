namespace ClangPowerTools.MVVM
{
  public class SettingsTooltips
  {
    ...
    public string CpuLimit { get; } = "Use the option to limit the number of cores for compile, tidy and tidy-fix to customize your performance and manage your computing resources more efficiently";
